        ...
        <div class="col-lg" id="main-container">
                ...
                <div class="card border-0">
                    ...
                    <div class="panel-body">
                        <h3 class="card-title">@lang(' Create Fee Structure ')</h3>
                        <form  id="add-form" method="POST" id="registerForm" action="/fees/fee_structures/store">
                            {{ csrf_field() }}
                        ...
                        <div id="FeeNames">
                            <div class="form-group row records">
                                <div class="col-md-4 mb-3">
                                    <label class="col-form-label"   for="validationTooltip02">Fee name</label>
                                    <input name="FeeName[]" type="text" class="form-control" id="validationTooltip01" placeholder="Books" value="{{$records[0]->name ?? ""}}" required>

                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="col-form-label"   for="validationTooltip03">Amount</label>
                            ...
                            @isset($records)
                                @for ($i = 1; $i < count($records); $i++)
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-4 mb-3">
                                            <label class="col-form-label"   for="validationTooltip01">Fee name</label>
                                            <input type="text" name="FeeName[]" class="form-control" id="validationTooltip01" placeholder="Books" value="{{$records[$i]->name}}" required>

                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="col-form-label"  for="validationTooltip02">Amount</label>
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    <label class="col-form-label"  for="ins1" >Installment 1 due date</label>
                            ...
                            <div id="InstalmentsList">
                                @isset($instalments)
                                    @for ($i = 1; $i < count($instalments); $i++)
                                        <div class="form-group row">
                                            <div class="col-md-4">
                                                <label class="col-form-label"  for="ins{{$i+1}}" >Installment {{$i+1}} due date</label>
                            ...
                            <br>
                            <br>
                            <button type="button" id="addFieldBtn" class="mr-5 btn btn-info float-right btn-sm">Add New Field</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#addFieldBtn").click(function () {
                $("#FeeNames").append(`<div class="form-group row">
                                <div class="col-md-4 mb-3">
                                    <label class="col-form-label"  for="validationTooltip01">Fee name</label>
                ...
                if(v > prev_length ){
                    for(i=prev_length+1;i<=parseInt(v);i++ ){
                        $("#InstalmentsList").append(
                            `<div class="form-group row">
                                <div class="col-md-4">
                                    <label class="col-form-label"  for="ins${i}"  >Installment ${i} due date</label>
