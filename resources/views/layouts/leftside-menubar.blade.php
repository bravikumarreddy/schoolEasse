...
<nav class="navbar navbar-expand-lg           border-0  navbar-dark bg-dark p-0 bg-primary" >
    ...
    <div class="navbar-toggler border-0 justify-content-center align-items-center mx-auto m-2"  data-toggle="collapse" data-target="#navbarSupportedContent"
        aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <button class="navbar-toggler" type="button">
            <span class="navbar-toggler-icon" > </span>
        </button>

        <h4 class="d-inline-block m-0  p-1"> Menu </h4>
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
        <ul class="nav flex-column p-2 flex-nowrap " id="side-navbar">
        <li class="nav-item active ">
            <a class="nav-link" href="{{ url('home') }}"><i class="material-icons">dashboard</i> <span
                    class="nav-link-text p-2">@lang('Dashboard')</span></a>
        </li>
        <li class="nav-item">
            {{--    <a class="nav-link active" href="{{ url('attendances/0/'.Auth::user()->id.'/0') }}"><i class="material-icons">date_range</i>--}}
            <a class="nav-link active" href="{{ url('/attendance/daily-attendance/calender') }}"><i
                    class="material-icons">table_view</i>
            ...
            <li class="nav-item dropdown">
                <a role="button" href="#" class="nav-link" data-toggle="dropdown" aria-haspopup="true"
                   aria-expanded="false"><i
                        class="material-icons">date_range</i> <span class="nav-link-text p-2">@lang('Attendance')</span>
                    <i class="material-icons float-right">keyboard_arrow_down</i></a>
                <ul class="dropdown-menu" style="width: 100%;">
                    <li class="nav-item">
                        <a class="dropdown-item" href="{{url('attendance/daily-attendance/teachers')}}"><i
                                class="material-icons">contacts</i> <span
                                class="nav-link-text p-2">@lang('Teacher Attendance')</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="dropdown-item" href="{{url('attendance/daily-attendance')}}"><i
                                class="material-icons">contacts</i> <span
                                class="nav-link-text p-2">@lang('Student Attendance')</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="dropdown-item" href="{{url('attendance/daily-attendance/staff')}}"><i
                                class="material-icons">account_balance_wallet</i> <span
                                class="nav-link-text p-2">@lang('Staff Attendance')</span></a>
                    </li>
                </ul>
            </li>
            <li class="nav-item">
                ...
                <a class="nav-link" href="{{ url('school/classes') }}"><i class="material-icons">class</i> <span
                        class="nav-link-text p-2">@lang('Classes &amp; Sections')</span></a>
        ...
        @if(Auth::user()->role == 'admin')
            <li class="nav-item dropdown">
                <a role="button" href="#" class="nav-link" data-toggle="dropdown" aria-haspopup="true"
                   aria-expanded="false"><i
                        class="material-icons">line_style</i> <span class="nav-link-text p-2">@lang('Exams')</span> <i
                        class="material-icons float-right">keyboard_arrow_down</i></a>
                <ul class="dropdown-menu" style="width: 100%;">
                    <!-- Dropdown menu links -->
                    {{--      <li>--}}
                    ...
                    <li>
                        <a class="dropdown-item" href="{{ url('exams') }}"><i class="material-icons">settings</i> <span
                                class="nav-link-text p-2">@lang('Manage Examinations')</span></a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="{{ url('exams/grade-system') }}"><i
                                class="material-icons">grade</i> <span
                                class="nav-link-text p-2">@lang('Grade System')</span></a>
                    </li>
                </ul>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('grades/all-grades') }}"><i class="material-icons">assignment</i> <span
                        class="nav-link-text p-2">@lang('Grades')</span></a>
            </li>
            </li>
            ...
            <li class="nav-item">
                ...
                <a class="nav-link" href="{{ url('time_table') }}"><i class="material-icons">calendar_today</i> <span
                        class="nav-link-text p-2">@lang('Class Time Table')</span></a>
            ...
            <li class="nav-item">
                {{--    <a class="nav-link" href="{{ url('academic/routine') }}"><i class="material-icons">calendar_today</i> <span class="nav-link-text p-2">@lang('Class Routine')</span></a>--}}
                <a class="nav-link" href="{{ url('leave/requests') }}"><i class="material-icons">ballot</i> <span
                        class="nav-link-text p-2">@lang('Leave Requests')</span></a>
            ...
            <li class="nav-item">
                ...
                <a class="nav-link" href="{{ url('/school_event') }}"><i class="material-icons">event</i> <span
                        class="nav-link-text p-2">@lang('Event')</span></a>

            </li>
            <li class="nav-item" style="border-bottom: 1px solid #dbd8d8;"></li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('settings.index') }}"><i class="material-icons">settings</i> <span
                        class="nav-link-text p-2">@lang('Academic Settings')</span></a>
            </li>
            {{--  <li class="nav-item dropdown">--}}
            ...
            {{--  </li>--}}
            <li class="nav-item">
                <a class="nav-link" href="{{ url('dashboard/setting') }}"><i class="material-icons">add_a_photo</i>
                    <span class="nav-link-text p-2">@lang('Slider Settings')</span></a>
            </li>
        @endif
            ...
            <li class="nav-item dropdown">
                <a role="button" href="#" class="nav-link" data-toggle="dropdown" aria-haspopup="true"
                   aria-expanded="false"><i
                        ...
                        class="nav-link-text p-2">@lang('Manage Fee')</span> <i class="material-icons float-right">keyboard_arrow_down</i></a>
                <ul class="dropdown-menu" style="width: 100%;">
                    <!-- Dropdown menu links -->
                    <li>
                        <a class="dropdown-item" href="{{ url('fees/analytics') }}"><i class="material-icons">insert_chart</i>
                            <span class="nav-link-text p-2">@lang('Analytics')</span></a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="{{ url('fees/fee_groups') }}"><i
                                class="material-icons">view_list</i> <span
                                class="nav-link-text p-2">@lang('Fee Structures')</span></a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="{{ url('fees/collect') }}"><i class="material-icons">money</i>
                            <span class="nav-link-text p-2">@lang('Collect Fees')</span></a>
                    </li>
{{--                    <li>--}}
{{--                        <a class="dropdown-item" href="{{ url('fees/all') }}"><i--}}
{{--                                class="material-icons">developer_board</i> <span--}}
{{--                                class="nav-link-text p-2">@lang('Generate Form')</span></a>--}}
{{--                    </li>--}}
                    {{--      <li>--}}
            ...
            <li class="nav-item dropdown">
                <a role="button" href="#" class="nav-link" data-toggle="dropdown" aria-haspopup="true"
                   aria-expanded="false"><i
                        class="material-icons">account_balance_wallet</i> <span
                        class="nav-link-text p-2">@lang('Manage Accounts')</span> <i class="material-icons float-right">keyboard_arrow_down</i></a>
                <ul class="dropdown-menu" style="width: 100%;">
                    <!-- Dropdown menu links -->
                    <li>
                    ...
                    <li>
                        <a class="dropdown-item" href="{{ url('accounts/income') }}"><i
                                class="material-icons">note_add</i> <span
                                class="nav-link-text p-2">@lang('Add New Income')</span></a>
                    </li>
                    <li>
        ...
        @if(Auth::user()->role == 'student')
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{url('payment')}}"><i class="material-icons">payment</i> <span
                        class="nav-link-text p-2">@lang('Payment')</span></a>
            </li>
            {{--  <li class="nav-item">--}}
            ...
            <li class="nav-item dropdown">
                <a role="button" href="#" class="nav-link" data-toggle="dropdown" aria-haspopup="true"
                   aria-expanded="false"><i
                        ...
                        class="nav-link-text p-2">@lang('Manage Library')</span> <i class="material-icons float-right">keyboard_arrow_down</i></a>
                <ul class="dropdown-menu" style="width: 100%;">
                    <!-- Dropdown menu links -->
                    <li>
                    ...
                    <li>
                        <a class="dropdown-item" href="{{ url('library/issue-books') }}"><i class="material-icons">receipt</i>
                            <span
        ...
        @if(Auth::user()->role == 'teacher' )
            ...
            <li class="nav-item">
                {{--    <a class="nav-link" href="{{ url('academic/routine') }}"><i class="material-icons">calendar_today</i> <span class="nav-link-text p-2">@lang('Class Routine')</span></a>--}}
                <a class="nav-link" href="{{ url('leave/teacher/requests') }}"><i class="material-icons">ballot</i>
                    <span class="nav-link-text p-2">@lang('Leave Requests')</span></a>
            ...
            <li class="nav-item dropdown">
                <a role="button" href="#" class="nav-link" data-toggle="dropdown" aria-haspopup="true"
                   aria-expanded="false"><i
                        class="material-icons">local_library</i> <span
                        class="nav-link-text p-2">@lang('Syllabus')</span> <i class="material-icons float-right">keyboard_arrow_down</i></a>
                <ul class="dropdown-menu" style="width: 100%;">
                    <!-- Dropdown menu links -->
                    <li>
        ...
        <li class="nav-item">
            ...
            <a class="nav-link" href="{{ url('communicate') }}"><i class="material-icons">send</i> <span
                    class="nav-link-text p-2">@lang('Communicate')</span></a>

        </li>
        <li class="nav-item">
        {{--    <a class="nav-link" href="{{ url('grades/all-exams-grade') }}"><i class="material-icons">assignment</i> <span class="nav-link-text p-2">@lang('Grades')</span></a>--}}
        <li class="nav-item">
            <a class="nav-link" href="{{ url('transportation') }}"><i class="material-icons">emoji_transportation</i>
                <span class="nav-link-text p-2">@lang('Transportation')</span></a>
        </li>
        </li>
        ...
        {{--    <a class="nav-link" href="{{ url('grades/all-exams-grade') }}"><i class="material-icons">assignment</i> <span class="nav-link-text p-2">@lang('Grades')</span></a>--}}
        <li class="nav-item">
            <a class="nav-link" href="{{ url('hostel') }}"><i class="material-icons">location_city</i> <span
                    class="nav-link-text p-2">@lang('Hostel')</span></a>
        </li>
