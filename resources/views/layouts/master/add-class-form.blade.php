    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="{{url('school/add-class')}}" method="post">
          ...
          <div class="form-group">
            <label for="classNumber{{$school->id}}" class="col-sm-8 col-form-label">@lang('Class Number/Name')</label>
            <div class="col-sm-8">
          ...
          --}}
{{--          <div class="form-group">--}}
{{--            <label for="classRoomNumber{{$school->id}}" class="col-sm-6 col-form-label">@lang('Class Group (If Any)')</label>--}}
{{--            <div class="col-sm-8">--}}
